...
void Manager::init() {
    ...
    QObject::connect(d, &DoublePlayerDialog::toMain, &TCPClient::instance(), &TCPClient::gameEnd);
//    QObject::connect(mm, &MultiPlayerMatchDialog::refuseCompeteQuery,
//                     &TCPClient::instance(),
//                     &TCPClient::sendRefuseCompeteQuery);

//    QObject::connect(mm, &MultiPlayerMatchDialog::agreeCompeteQuery,
